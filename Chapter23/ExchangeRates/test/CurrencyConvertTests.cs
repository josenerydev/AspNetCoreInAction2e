...
{
    /// <summary>
    /// Unit tests for the <see cref="CurrencyConverter" />
    /// </summary>
    public class CurrencyConvertTests
    {
        [Fact]
        public void CovertToGbp_ConvertsCorrectly()
        {
        ...
        public void Converts(decimal value, decimal rate, decimal expected)
        {
            ...
            var actual = convert.ConvertToGbp(value, rate, dps);
        ...
        public void ThrowsExceptionIfRateIsLessThanZero(decimal rate)
        {
            ...
            var ex = Assert.Throws<ArgumentException>(
                () => convert.ConvertToGbp(value, rate, dp));
        }
        ...
        public void ThrowsExceptionIfDecimalPlacesIsLessThanZero()
        {
            ...
            Assert.Throws<ArgumentException>(() => convert.ConvertToGbp(value, exchangeRate, decimalPlaces));
        }
